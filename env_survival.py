...
from preys_logic1 import BasicPreyLogic
from preys_logic2 import AdvancedPreyLogic
...
class SurvivalEnv(_BaseEnv):
    """Basic survival environment that delegates prey logic to :mod:`preys_logic1`."""
...
class SurvivalEnvV2(_BaseEnv):
    """Advanced survival environment relying on :mod:`preys_logic2` for prey behaviour."""
...
__all__ = ["SurvivalEnv", "SurvivalEnvV2", "Pos"]
